...
test('estimate the gas price', async () => {
  ...
  expect(average).toEqual(gasPrice(89000000000));
  expect(fast).toEqual(gasPrice(91000000000));
  expect(fastest).toEqual(gasPrice(100000000000));
  expect(safeLow).toEqual(gasPrice(82000000000));
});
...
test('estimate the gas price when gas station fails', async () => {
  ...
  const fastest = await estimate('fastest');
  const safeLow = await estimate('safeLow');
  expect(average).toEqual(gasPrice(135000000000));
  expect(fast).toEqual(gasPrice(148500000000));
  expect(fastest).toEqual(gasPrice(162000000000));
  expect(safeLow).toEqual(gasPrice(135000000000));
});
